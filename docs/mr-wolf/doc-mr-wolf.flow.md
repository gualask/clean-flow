...
2. Frame the problem: clarify intent, success criteria, constraints, non-goals, uncertainty, risk appetite, and the useful perimeter for the decision under Cflow's clean-by-default standard.
