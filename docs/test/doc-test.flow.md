...
1. Resolve pending tests, a named history range, or explicit test targets. Separate primary tests, contract surfaces, authoritative sources, and exclusions without loading the corpus in full.
