...
Use `cf-split`, `cf-cognitive`, or `cf-cohesion` directly only when the user asks for one explicit local action and no broader Cflow planning or resume state is needed.
