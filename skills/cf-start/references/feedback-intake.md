...
Do not implement feedback blindly in this phase.
...
- Only after that recommend whether to:
  ...
  - narrow it
  - reject it
  - route back to another Cflow phase
- If you recommend accepting or narrowing the feedback, name the exact next Cflow phase instead of suggesting generic follow-up work.
