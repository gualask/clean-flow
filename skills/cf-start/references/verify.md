...
If a move, rename, split, merge, or re-export happened, ensure you have read references/reference-audit.md in this invocation, then run that audit for the touched names and paths.
