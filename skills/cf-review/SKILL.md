...
- Test files selected by the change set remain **Primary files** for structural, convention, dependency, transition, and documentation lenses. Do not classify or count them separately, and do not assess their assertion quality in this pass.
