---
name: cf-docs
description: Generate or review documentation for accuracy against the code, duplication, verbosity, and structural drift. Use when writing, updating, trimming, or fact-checking Markdown docs, READMEs, or design notes, or when docs may be stale. Do not use just to save analysis output or notes into a .md file, for grammar linting alone, or in a repository without source code; route code grouping to cf-cohesion.
---
