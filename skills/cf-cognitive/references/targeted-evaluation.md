...
- When the canonical file-length trigger fires, include an explicit file-size verdict in **Result**: `route` to `cf-split`, or the named exemption that justifies its size.
